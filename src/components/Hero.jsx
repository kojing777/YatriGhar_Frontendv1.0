...
const Hero = () => {
  ...
  return (
    <div className="relative h-screen overflow-hidden flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32">

      {/* Background Image */}
      <div
        className="absolute inset-0 bg-cover bg-center"
        style={{
          backgroundImage: 'url("/src/assets/nepal1.jpg")',
        }}
      ></div>

      {/* Soft Sunrise Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-br from-amber-200/40 via-transparent to-transparent"></div>
